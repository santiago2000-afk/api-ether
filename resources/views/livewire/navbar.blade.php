<div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="#" class="text-sm font-medium px-3 py-2 transition-all hover:text-blue-500 hover:scale-105 transform duration-200 ease-in-out">Portfolios</a>
                </div>
    ...
    <div id="mobile-menu" class="md:hidden fixed top-0 left-0 w-full h-full bg-white z-40 transform translate-x-full transition-all duration-300 ease-in-out">
        ...
        <div class="flex flex-col items-center space-y-4 mt-8">
            ...
            <a href="#" class="text-xl text-gray-600 hover:text-blue-500">Portfolios</a>
        </div>
    </div>
